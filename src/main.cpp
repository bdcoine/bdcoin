...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 365 * 2;	// stake age of full weight: 10 y
unsigned int nStakeTargetSpacing = 60;			// 60 sec block spacing

int64 nChainStartTime = 1465545211;
...
const string strMessageMagic = "BDCoin Signed Message:\n";
...
bool CTransaction::IsStandard() const
{
    ...
    BOOST_FOREACH(const CTxIn& txin, vin)
    {
        ...
        // 2016-04-15 Adriano https://bitcointalk.org/index.php?action=profile;u=112568
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in BDCoin
    bool fStrictPayToScriptHash = true; // Always active in BDCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BDCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "4/15/2016, Bitcoin, Height:309113, BlockHash:000...e10e764fba407c8ea4f5c6ed12f";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 289790 : 4365;
        ...
        assert(block.hashMerkleRoot == uint256("0xa4d34d3a98e9e15b5797172daa33c353d43fa60336e026703147cd33f9df2f69"));
